...
export const backend: Learn = {
  list: [
    ...
    'Knowledge of Algorithms and data structures is also essential for any professional full stack developer',
    'Awareness of security concerns is important, as each layer has its vulnerabilities',
